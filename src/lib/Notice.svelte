...
<main class="raiden-version-notice">
	<div class="raiden-version-notice-body">
		...
		<div class="notice-handle">
			<button class="notice-handle-btn btn-text" on:click={ignore}>{langData.ignore}</button>
			<button class="notice-handle-btn btn-primary" on:click={upgrade}>{langData.upgrade}</button>
		</div>
	</div>
</main>
